...
urlpatterns = [
    ...
    path('section/', CreateSectionForm.as_view(), name='section_create'),
    path('faculty/', SelectFaculty.as_view(), name='select_faculty'),
    path('account/section/', UserSectionView.as_view(), name='section_list'),
